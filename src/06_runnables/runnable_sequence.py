"""
File: runnable_sequence.py

Description
-----------
Demonstrates RunnableSequence.

RunnableSequence allows multiple LangChain components to execute one
after another, where the output of one component automatically becomes
