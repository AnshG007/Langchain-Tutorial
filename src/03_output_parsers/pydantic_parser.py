...
Description
-----------
Demonstrates how to use PydanticOutputParser to parse and validate
LLM responses against a predefined schema.
"""
...
def main():
    print_title("Pydantic Output Parser Example")

    llm = get_llm()

    # Create a PydanticOutputParser for the Employee schema
    parser = PydanticOutputParser(pydantic_object=Employee)

# Define a prompt template that instructs the LLM to return structured output
